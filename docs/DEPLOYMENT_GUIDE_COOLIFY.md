...
VITE_APP_VERSION=Trial Version 1.0.0
VITE_APP_TRADE_MARK=@nababancloud.net
VITE_GOOGLE_MAPS_API_KEY=YOUR_GOOGLE_MAPS_KEY_HERE
VITE_SUPABASE_URL=https://druzejkezbqzarnadxhm.supabase.co
VITE_SUPABASE_ANON_KEY=sb_publishable_n-NMq2rJj5n5Y6PNXAM4Bg_ayMkUQoT
```
