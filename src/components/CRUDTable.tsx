...
export const CRUDTable = <TData extends Record<string, any>>({
  ...
  return (
    <div className="space-y-6 bg-white p-6 md:p-8 rounded-2xl shadow-soft border border-gray-100">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-astra-charcoal">{title}</h2>
